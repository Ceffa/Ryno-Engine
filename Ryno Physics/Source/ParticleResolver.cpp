...
namespace RynoEngine {
	...
	void ParticleResolver::resolve_contacts(ParticleContact* contacts, U contacts_number, F duration)
	{
		...
		for (current_iteration = 0; current_iteration < max_iterations; current_iteration++) {
			...
			//is done after.
			F max_vel = FLT_MAX;
			U max_idx = contacts_number;

			//Find contact with lower separating speed;
			for (I i = 0; i < contacts_number; i++) {
