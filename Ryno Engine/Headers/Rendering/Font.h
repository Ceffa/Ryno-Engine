...
#define LAST_PRINTABLE_CHAR ((C)126)
    ...
    public:
		Font() {}
		void create(std::string font, U32 size, Owner loc, C cs, C ce);
		void create(std::string font, U32 size, Owner loc) {
			create(font, size, loc, FIRST_PRINTABLE_CHAR, LAST_PRINTABLE_CHAR);
        }
