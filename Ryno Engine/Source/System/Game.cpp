...
namespace Ryno{
	...
	void Game::init_external_systems(){
		...
		if ((window = SDL_CreateWindow("Ryno Engine", WindowPos::x, WindowPos::y, WindowSize::w, WindowSize::h, SDL_WINDOW_OPENGL | SDL_WINDOW_INPUT_FOCUS | SDL_WINDOW_MOUSE_FOCUS)) == NULL){
