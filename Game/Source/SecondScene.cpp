...
namespace Ryno{
	...
	void SecondScene::start(){
		...
		go->transform->set_scale(200,200,200);
		go->transform->set_position(40, 55, 50);
	...
	void SecondScene::BuildQuadForGrid(glm::vec3 position, glm::vec2 uv,
