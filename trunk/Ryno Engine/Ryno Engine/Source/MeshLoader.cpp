...
namespace Ryno{
	...
	MeshLoader& MeshLoader::get_instance(){

		static MeshLoader instance;//only at the beginning
		return instance;
	}

	Mesh* MeshLoader::get_mesh(I32 mesh_number){
		return meshes[mesh_number-1];
	}

	I32 MeshLoader::load_mesh(const std::string& name, ColorRGBA color)
	{
